...
};System.register(['angular2/angular2', 'angular2/src/directives/class', './message.event'], function(exports_1) {
    var angular2_1, class_1, message_event_1;
    var CommonLogin;
    return {
        setters:[
