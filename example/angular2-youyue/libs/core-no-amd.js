...
perfmjs.plugin('appConfig', function($$) {
    $$.base("appConfig", {
        ...
        extendConfig: function(options) {
            if (options && !this.option('globalConfigLoaded')) {
...
perfmjs.plugin('includeRes', function($$) {
	...
	$$.includeRes = {
		...
		_parseLoadedRes: function(options) {
			...
			options = $$.utils.extend({loadfile:'core-[0-9]+.[0-9]+.[0-9]+.js|core-[0-9]+.[0-9]+.[0-9]+.min.js|onlyforload.js|core.min.js|core.js|core-no-amd.js', isScript:false, src:'{n:"",t:"js",m:"default;"}'}, options);
            //将sources数组清空并初始化
