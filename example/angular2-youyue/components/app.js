...
};System.register(['angular2/angular2', 'angular2/di', 'angular2/router', 'perfmjs/angular2/directives/common-login', '../services/common-service', './ToutiaoIndex', './ToutiaoDetail', './cmsEdit'], function(exports_1) {
