(function(){
	...
	domReady(function(){
		...
		_$('web_btn1').onclick = function(){
			webAlert({title:'图片查看',lock:true,  time:2, content:'<img width="300" height="200" perfmjs="http://www.hunanyishi.cn/images/main.jpg" />'});
			return false;
		};
