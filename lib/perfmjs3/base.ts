...
$$.base = function(name:string, prototype:any, parentPrototype:any, parentDefaults:any) {
    ...
    $$[name] = $$.base[name] = $$[namespace][name] = function(callInitFunc:any, options:any) {
    ...
    $$[namespace][name].newInstance = function(args:any, options:any) {
        if ($$[name]['instance']) {
            return $$[name]['instance'];
        }
        var _inst = new $$[namespace][name](false, options); _inst.init(args);
        return _inst;
    };
    $$[namespace][name].prototype = $$.utils.extend(true, {}, parentPrototype, prototype);
    $$[namespace][name].prototype._super = function(funcName:any, options:any) {
