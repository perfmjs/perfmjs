...
/**fetch polyfill v0.9.0 ref to: https://raw.githubusercontent.com/github/fetch/master/fetch.js*/
System.register("perfmjs/fetch", [], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            ...
            exports_1("FetchPolyfill", FetchPolyfill);
        }
    }
});
    ...
    return {
        ...
        execute: function() {
            ...
            !function (win, undefined) {
                ...
                utils_1.utils.root.headLoad = api;
                /*for perfmjs end*/
            }(window);
            exports_1("headLoad", headLoad = utils_1.utils.root.headLoad);
        }
    }
});
